...
<glade-catalog version="3.12" targetable="3.10,3.8,3.6,3.4,3.2,3.0" name="gtk+" library="gladegtk" icon-prefix="gtk" domain="glade" book="gtk3">
  <glade-widget-classes>
    ...
    <glade-widget-class name="GtkWidget" default-width="100" default-height="60" title="Widget">
      ...
      <actions>
        <action stock="gtk-execute" important="True" id="preview" name="Preview snapshot"></action>
        <action stock="gtk-edit" id="edit_separate" name="Edit Separately"></action>
        <action stock="gtk-remove" id="remove_parent" name="Remove Parent"></action>
        <action stock="gtk-add" id="add_parent" name="Add Parent">
        ...
        <action stock="gtk-clear" id="clear_properties" name="Clear properties"></action>
        ...
        <properties>
          ...
          <property save="False" ignore="True" id="AtkObject::accessible-role" default="invalid" atk-property="True" name="Role">
            ...
            <displayable-values>
              ...
              <value id="ATK_ROLE_DIRECTORY_PANE" name="Directory Name"></value>
      ...
      <glade-widget-class name="GtkBox" generic-name="box" title="Box">
        ...
        <packing-actions>
          <action stock="gtk-add" id="insert_before" name="Insert Before"></action>
          <action stock="gtk-add" id="insert_after" name="Insert After"></action>
      ...
      <glade-widget-class toplevel="True" name="GtkWindow" generic-name="window" default-width="440" default-height="250" title="Window">
        ...
        <properties> 
          ...
          <property weight="0.5" since="2.16" save="False" name="Accel Groups" ignore="True" id="accel-groups" custom-layout="True">
            <parameter-spec>
              <type>GladeParamObjects</type>
      ...
      <glade-widget-class use-placeholders="False" since="2.16" name="GtkMenuItem" generic-name="menuitem" title="Menu Item">
        ...
        <properties>
          ...
          <property since="2.16" save="False" optional-default="False" optional="True" needs-sync="True" id="related-action" custom-layout="True" name="Related Action"></property>
          <property since="2.16" save="False" optional-default="False" optional="True" needs-sync="True" id="use-action-appearance" default="False" custom-layout="True" name="Use Action Appearance"></property>
      ...
      <glade-widget-class name="GtkCheckButton" generic-name="checkbutton" title="Check Button">
        <properties>
          ...
          <property save-always="True" id="xalign"/>
        </properties>
      </glade-widget-class>
      ...
      <glade-widget-class name="GtkSwitch" generic-name="switch" title="Switch">
        ...
        <properties>
          ...
          <property save="False" optional-default="False" optional="True" needs-sync="True" id="related-action" custom-layout="True" name="Related Action">
            <parameter-spec>
              <type>GParamObject</type>
              <value-type>GtkToggleAction</value-type>
            </parameter-spec>
          </property>
          <property save="False" optional-default="False" optional="True" needs-sync="True" id="use-action-appearance" default="False" custom-layout="True" name="Use Action Appearance"></property>
      ...
      <glade-widget-class name="GtkTable" generic-name="table" deprecated="True" title="Table">
        ...
        <packing-actions>
          <action stock="gtk-add" id="insert_row" name="Insert Row">
            <action id="before" name="Before"></action>
            <action id="after" name="After"></action>
          </action>
          <action stock="gtk-add" id="insert_column" name="Insert Column">
            <action id="before" name="Before"></action>
            <action id="after" name="After"></action>
          </action>
          <action stock="gtk-remove" id="remove_row" name="Remove Row"></action>
          <action stock="gtk-remove" id="remove_column" name="Remove Column"></action>
        </packing-actions>
      ...
      <glade-widget-class use-placeholders="False" since="3.10" name="GtkListBox" generic-name="listbox" title="List Box">
        ...
        <actions>
          <action stock="gtk-add" important="True" id="add_row" name="Add Row"></action>
        </actions>
      ...
      <glade-widget-class since="3.10" name="GtkListBoxRow" generic-name="listboxrow" title="List Box Row"></glade-widget-class>
      ...
      <glade-widget-class since="3.4" name="GtkColorChooserWidget" icon-name="widget-gtk-colorselection" generic-name="colorchooserwidget" title="Color Chooser Widget"></glade-widget-class>
      ...
      <glade-widget-class use-placeholders="False" toplevel="True" name="GtkAction" generic-name="action" title="Action">
      ...
      <glade-widget-class since="2.12" name="GtkRecentAction" generic-name="recentaction" title="Recent Action">
        <properties>
      ...
      <glade-widget-class use-placeholders="False" toplevel="True" name="GtkActionGroup" generic-name="actiongroup" title="Action Group">
        ...
        <properties>
          ...
          <property save="False" id="accel-mods" custom-layout="True">
            <displayable-values>
              ...
              <value id="GDK_BUTTON4_MASK" name="Forth Mouse Button"></value>
    ...
    <glade-widget-group name="gtk-actions" title="Actions">
